...
var x__9407__auto__ = (((rng == null))?null:rng);
var m__9408__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__9407__auto__)]);
if(!((m__9408__auto__ == null))){
return m__9408__auto__.call(null,rng);
} else {
var m__9408__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__9408__auto____$1 == null))){
return m__9408__auto____$1.call(null,rng);
} else {
...
var x__9407__auto__ = (((rng == null))?null:rng);
var m__9408__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__9407__auto__)]);
if(!((m__9408__auto__ == null))){
return m__9408__auto__.call(null,rng);
} else {
var m__9408__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__9408__auto____$1 == null))){
return m__9408__auto____$1.call(null,rng);
} else {
...
var x__9407__auto__ = (((rng == null))?null:rng);
var m__9408__auto__ = (clojure.test.check.random.split[goog.typeOf(x__9407__auto__)]);
if(!((m__9408__auto__ == null))){
return m__9408__auto__.call(null,rng);
} else {
var m__9408__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__9408__auto____$1 == null))){
return m__9408__auto____$1.call(null,rng);
} else {
...
var x__9407__auto__ = (((rng == null))?null:rng);
var m__9408__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__9407__auto__)]);
if(!((m__9408__auto__ == null))){
return m__9408__auto__.call(null,rng,n);
} else {
var m__9408__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__9408__auto____$1 == null))){
return m__9408__auto____$1.call(null,rng,n);
} else {
...
return clojure.test.check.random.longs.bit_xor.call(null,G__21029,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__21029;
}
});
...
var G__21032 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__21033 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__21032;
ret = G__21033;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__9345__auto__,writer__9346__auto__,opt__9347__auto__){
return cljs.core._write.call(null,writer__9346__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__8674__auto__ = clojure.test.check.random.longs.__GT_long.call(null,seed);
...
var map__21035 = p__21034;
var map__21035__$1 = ((((!((map__21035 == null)))?((((map__21035.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21035.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21035):map__21035);
var state = cljs.core.get.call(null,map__21035__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__21037 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__21037,(0),null);
var r2 = cljs.core.nth.call(null,vec__21037,(1),null);
