...
return cljs.core.assoc.call(null,G__22607,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__22607;
}
});
...
var or__8674__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__9953__auto___22612 = arguments.length;
var i__9954__auto___22613 = (0);
while(true){
if((i__9954__auto___22613 < len__9953__auto___22612)){
args__9960__auto__.push((arguments[i__9954__auto___22613]));

var G__22614 = (i__9954__auto___22613 + (1));
i__9954__auto___22613 = G__22614;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__9961__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq22609){
var G__22610 = cljs.core.first.call(null,seq22609);
var seq22609__$1 = cljs.core.next.call(null,seq22609);
var G__22611 = cljs.core.first.call(null,seq22609__$1);
var seq22609__$2 = cljs.core.next.call(null,seq22609__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__22610,G__22611,seq22609__$2);
});
...
var file = cljs.core.get.call(null,map__22616__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__22616__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__22616__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__22616,map__22616__$1,file,line,column){
return (function (p1__22615_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__22615_SHARP_));
});})(map__22616,map__22616__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__9729__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__9729__auto__,prefer_table__9730__auto__,method_cache__9731__auto__,cached_hierarchy__9732__auto__,hierarchy__9733__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__8674__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__8674__auto__)){
return or__8674__auto__;
} else {
...
var temp__5457__auto___22618 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___22618)){
var message_22619 = temp__5457__auto___22618;
cljs.core.println.call(null,message_22619);
} else {
}
...
var temp__5457__auto___22620 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___22620)){
var message_22621 = temp__5457__auto___22620;
cljs.core.println.call(null,message_22621);
} else {
}
...
var output_dir = "C:\\Users\\KyuBok\\.boot\\cache\\tmp\\Projects\\cwbn-clj\\cwbn\\5u0\\-9uliv9\\cwbn\\main.out";
var output_dir__$1 = (function (){var G__22622 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22622),"/"].join('');
} else {
return G__22622;
}
})();
...
var temp__5455__auto__ = (function (){var and__8662__auto__ = typeof exception.stack === 'string';
if(and__8662__auto__){
var G__22624 = exception.stack;
var G__22624__$1 = (((G__22624 == null))?null:clojure.string.split_lines.call(null,G__22624));
var G__22624__$2 = (((G__22624__$1 == null))?null:cljs.core.get.call(null,G__22624__$1,depth));
if((G__22624__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__22624__$2);
}
} else {
...
var vec__22625 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__22625,(0),null);
var column = cljs.core.nth.call(null,vec__22625,(1),null);
var vec__22628 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__22628,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__22628,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__22628,(2),null);
...
var m__$1 = (function (){var G__22631 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__22635 = (function (){var G__22634 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__22634);
} else {
return G__22634;
}
})();
...
return cljs.core.vary_meta.call(null,G__22636,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__22640 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__22640,(0),null);
var types = vec__22640;
...
return cljs.core.map.call(null,(function (p__22643){
var vec__22644 = p__22643;
var ns = cljs.core.nth.call(null,vec__22644,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__22644,(1),null);
return ((function (vec__22644,ns,vars__$1){
return (function (){
...
var G__22647 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__22647,G__22647__$1,env,once_fixtures,each_fixtures,vec__22644,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__22647,G__22647__$1,env,once_fixtures,each_fixtures,vec__22644,ns,vars__$1){
return (function (){
var seq__22648 = cljs.core.seq.call(null,vars__$1);
var chunk__22649 = null;
var count__22650 = (0);
var i__22651 = (0);
while(true){
if((i__22651 < count__22650)){
var v = cljs.core._nth.call(null,chunk__22649,i__22651);
var temp__5457__auto___22653 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___22653)){
var t_22654 = temp__5457__auto___22653;
each_fixture_fn.call(null,((function (seq__22648,chunk__22649,count__22650,i__22651,t_22654,temp__5457__auto___22653,v,each_fixture_fn,G__22647,G__22647__$1,env,once_fixtures,each_fixtures,vec__22644,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_22654)));
});})(seq__22648,chunk__22649,count__22650,i__22651,t_22654,temp__5457__auto___22653,v,each_fixture_fn,G__22647,G__22647__$1,env,once_fixtures,each_fixtures,vec__22644,ns,vars__$1))
);
} else {
}

var G__22655 = seq__22648;
var G__22656 = chunk__22649;
var G__22657 = count__22650;
var G__22658 = (i__22651 + (1));
seq__22648 = G__22655;
chunk__22649 = G__22656;
count__22650 = G__22657;
i__22651 = G__22658;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__22648);
if(temp__5457__auto__){
var seq__22648__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__22648__$1)){
var c__9605__auto__ = cljs.core.chunk_first.call(null,seq__22648__$1);
var G__22659 = cljs.core.chunk_rest.call(null,seq__22648__$1);
var G__22660 = c__9605__auto__;
var G__22661 = cljs.core.count.call(null,c__9605__auto__);
var G__22662 = (0);
seq__22648 = G__22659;
chunk__22649 = G__22660;
count__22650 = G__22661;
i__22651 = G__22662;
continue;
} else {
var v = cljs.core.first.call(null,seq__22648__$1);
var temp__5457__auto___22663__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___22663__$1)){
var t_22664 = temp__5457__auto___22663__$1;
each_fixture_fn.call(null,((function (seq__22648,chunk__22649,count__22650,i__22651,t_22664,temp__5457__auto___22663__$1,v,seq__22648__$1,temp__5457__auto__,each_fixture_fn,G__22647,G__22647__$1,env,once_fixtures,each_fixtures,vec__22644,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_22664)));
});})(seq__22648,chunk__22649,count__22650,i__22651,t_22664,temp__5457__auto___22663__$1,v,seq__22648__$1,temp__5457__auto__,each_fixture_fn,G__22647,G__22647__$1,env,once_fixtures,each_fixtures,vec__22644,ns,vars__$1))
);
} else {
}

var G__22665 = cljs.core.next.call(null,seq__22648__$1);
var G__22666 = null;
var G__22667 = (0);
var G__22668 = (0);
seq__22648 = G__22665;
chunk__22649 = G__22666;
count__22650 = G__22667;
i__22651 = G__22668;
continue;
}
} else {
...
});})(each_fixture_fn,G__22647,G__22647__$1,env,once_fixtures,each_fixtures,vec__22644,ns,vars__$1))
);
});})(each_fixture_fn,G__22647,G__22647__$1,env,once_fixtures,each_fixtures,vec__22644,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22647__$1)].join('')));

}
})());
});
;})(vec__22644,ns,vars__$1))
