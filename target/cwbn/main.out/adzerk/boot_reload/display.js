...
var attr = cljs.core.nth.call(null,vec__19345,(0),null);
...
var len__9953__auto___19352 = arguments.length;
var i__9954__auto___19353 = (0);
while(true){
if((i__9954__auto___19353 < len__9953__auto___19352)){
args__9960__auto__.push((arguments[i__9954__auto___19353]));

var G__19354 = (i__9954__auto___19353 + (1));
i__9954__auto___19353 = G__19354;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq19351){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19351));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__19355){
...
var G__19358 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__19358,goog.events.EventType.CLICK,((function (G__19358,map__19356,map__19356__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__19358,map__19356,map__19356__$1,data,message,line,file))
);

return G__19358;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__19359){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__19363){
var map__19364 = p__19363;
var map__19364__$1 = ((((!((map__19364 == null)))?((((map__19364.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19364.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19364):map__19364);
var messages = map__19364__$1;
var warnings = cljs.core.get.call(null,map__19364__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__19364__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__19366 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__19366,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__19366,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__19367){
...
var messages = map__19368__$1;
var warnings = cljs.core.get.call(null,map__19368__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__19368__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__19368,map__19368__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__19368,map__19368__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__19368,map__19368__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__19368,map__19368__$1,messages,warnings,exception))
;
...
}catch (e19370){if((e19370 instanceof Error)){
var __19371 = e19370;
} else {
throw e19370;
