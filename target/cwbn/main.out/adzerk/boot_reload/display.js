...
return (function (p__19351){
var vec__19352 = p__19351;
var attr = cljs.core.nth.call(null,vec__19352,(0),null);
...
var len__9953__auto___19359 = arguments.length;
var i__9954__auto___19360 = (0);
while(true){
if((i__9954__auto___19360 < len__9953__auto___19359)){
args__9960__auto__.push((arguments[i__9954__auto___19360]));

var G__19361 = (i__9954__auto___19360 + (1));
i__9954__auto___19360 = G__19361;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq19358){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19358));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__19362){
...
var data = map__19363__$1;
var message = cljs.core.get.call(null,map__19363__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__19363__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__19363__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__19365 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__19365,goog.events.EventType.CLICK,((function (G__19365,map__19363,map__19363__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__19365,map__19363,map__19363__$1,data,message,line,file))
);

return G__19365;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__19366){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__19370){
...
var messages = map__19371__$1;
var warnings = cljs.core.get.call(null,map__19371__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__19371__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__19373 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__19373,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__19373,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__19374){
...
var messages = map__19375__$1;
var warnings = cljs.core.get.call(null,map__19375__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__19375__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__19375,map__19375__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__19375,map__19375__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__19375,map__19375__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__19375,map__19375__$1,messages,warnings,exception))
;
